...
// Custom web paths for existing files
/// Relative web icons folder path (for copying existing icons)
String webIconsFolder = path.join(webDirPath, 'icons/');

/// Relative web resources folder path
String webResFolder = path.join(webDirPath);

/// New apple touch icon file path
String newAppleTouchIconFilePath = 'icons/apple-touch-icon.png';

/// New shortcut icon file path
String newShortcutIconFilePath = 'icons/favicon.ico';
